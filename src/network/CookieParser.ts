import { NetworkCookie } from './NetworkCookie.js';
...
export class CookieParser {
  ...
  private _lastCookie: NetworkCookie | undefined;
  private _cookies: NetworkCookie[] | undefined;
  ...
  private _extractKeyValue(): KeyValue | undefined {
    ...
    const keyValueMatch: string[] | null =
      /^[ \t]*([^\s=;]+)[ \t]*(?:=[ \t]*([^;\n]*))?/i.exec(this._input);
